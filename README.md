...
$ java -jar target/uberjar/demo.todomvc-0.6.1-0.2.0-SNAPSHOT-standalone.jar -vf config/config.edn
```
...
```shell
$ java -jar target/uberjar/demo.todomvc-0.6.1-0.2.0-SNAPSHOT-standalone.jar -c purge -vf config/config.edn
```
